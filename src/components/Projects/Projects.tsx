    ...
    <div className='project' id='projects'>
      ...
      <LazyLoad once height={400}>
        <section className='project__section'>
          ...
          <div className='project__right'>
            ...
            <a href='javascript:void(0)' target='_blank' rel='noreferrer' className='project__headingSecondary'><h2>Colors.co</h2></a>
            <div className='project__descriptionContainer'>
              ...
              <div className='project__icons'>
                <a href='javascript:void(0)' target='_blank' rel='noreferrer' style={{ marginRight: '1.6rem' }}>
      ...
      <LazyLoad once height={400}>
        <section className='project__section'>
          <div className='project__left1'>
            <h3 className='project__headingTertiary'>Featured Project</h3>
            <a href='javascript:void(0)' target='_blank' rel='noreferrer' className='project__headingSecondary'><h2>YelpCamp Campgrounds</h2></a>
      ...
      <LazyLoad once height={400}>
        <section className='project__section project__section3'>
          ...
          <div className='project__right'>
            <h3 className='project__headingTertiary'>Featured Project</h3>
            <a href='javascript:void(0)' target='_blank' rel='noreferrer' className='project__headingSecondary'><h2>Online Grocery store</h2></a>
            <div className='project__descriptionContainer'>
              <p className='project__description'>
